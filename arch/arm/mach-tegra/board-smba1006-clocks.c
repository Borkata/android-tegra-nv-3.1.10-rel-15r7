/*
 * arch/arm/mach-tegra/board-smba1006-clocks.c
 *
...
static __initdata struct tegra_clk_init_table smba_clk_init_table[] = {
	...
	{ "pll_c_out1",	"pll_c",		109090909,	true},		/* must be always on - system clock */
...
#	endif
	...
	/* pll_x */
	{ "pll_x",  	"clk_m",        389000000,  true},		/* */
	{ "cclk",		"pll_x",		389000000,  true},	
	{ "cpu",		"cclk",			389000000,  true},	
	...
	{ "vi",     	"pll_m",   		111000000,  false},		/* tegra_camera : unused on smba */
	{ "vi_sensor",	"pll_m",		111000000,	false},		/* tegra_camera : unused on smba */
	{ "csi",		"pll_p_out3",	 72000000,	false},		/* tegra_camera */
	{ "isp",		"clk_m",		 12000000,	false},		/* tegra_camera */
	{ "csus",		"clk_m",		 12000000,	false},		/* tegra_camera */

#ifdef ALC5623_IS_MASTER		
	{ "i2s1",   	"clk_m",          2822400,  false},		/* i2s.0 */
...
#	endif
	...
	{ "uartc",		"pll_p",		 12000000,	false},		/* tegra_uart.2 uart.2 */	
	...
	{ "pwm",    	"clk_m",   		    93385,  false},		/* tegra-pwm.0 tegra-pwm.1 tegra-pwm.2 tegra-pwm.3*/
