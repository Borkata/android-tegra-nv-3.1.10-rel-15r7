/*
 * arch/arm/mach-tegra/board-smba1006-pinmux.c
 *
...
/*        { .gpio = SMBA1006_GPSMAG_DISABLE,      .enable = true  },*/
	...
	{ .gpio = SMBA1006_SDINT_POWER,		.enable = true	},
	{ .gpio = SMBA1006_HP_DETECT,		.enable = true	},
	{ .gpio = SMBA1006_INT_MIC_EN,		.enable = true	},
	{ .gpio = SMBA1006_AC_PRESENT,    	.enable = true  },
	{ .gpio = SMBA1006_USB0_VBUS,		.enable = false },
	{ .gpio = SMBA1006_ENABLE_VDD_VID,  	.enable = true  }, //FIX MEEE
};
